...
# =============================================================================
#         if(side == 0):
#             print("Bid Price-------->",price," ",side)
# =============================================================================
            
# =============================================================================
#             df_tab = pd.DataFrame([[size,price]], columns = ["Size","Price"])    
#             self.bid_tab = pd.concat([self.bid_tab, df_tab])             
#            
#             if(len(self.bid_tab)>=5):
#                 self.bid_tab = self.bid_tab.tail(5)
#         
#                 xx =self.bid_tab["Price"].iloc[1]+self.bid_tab["Price"].iloc[2]
# =============================================================================

# =============================================================================
#         else :        
#             print("Ask Price-------->",price," ",side) 
# =============================================================================
            
# =============================================================================
#             df_tab = pd.DataFrame([[size,price]], columns = ["Size","Price"])    
#             self.ask_tab = pd.concat([self.ask_tab, df_tab])             
#             
#             if(len(self.ask_tab)>=5):
#                 self.ask_tab = self.ask_tab.tail(5)
#                
#                 yy=self.ask_tab["Price"].iloc[1]+self.ask_tab["Price"].iloc[2]
#                 
# =============================================================================
        ...
        if(self.order_for_placing == True):
            ...
            if(self.open_inventory_position_at_giventime[c.symbol] == 0):
                ...
                Delta = self.Risk_aversion_Coefficient*price*price*self.YEARLY_Volatility_for_Lookback_Period*self.YEARLY_Volatility_for_Lookback_Period*self.TIME_HORIZON_in_Fractional_years
            ...
            #************************************3/Condition 2 START***********************************************# 
                ...
                self._send_lmt_order(self.contracts[reqId],"BUY",self.open_inventory_position_at_giventime[c.symbol],round(price - (price % GlobalMinTick), 1))
                ...
                self._send_lmt_order(self.contracts[reqId],"SELL",self.open_inventory_position_at_giventime[c.symbol],round(price - (price % GlobalMinTick), 1))
...
for i in range(len(contracts)):
    ...
    app.reqMktDepth(i, contracts[i], 10, False, [])
